...
SFML_ingameMenu::SFML_ingameMenu(std::string gameMenufilename, int windowWidth, int windowHeight)
{
	std::ifstream inputFile(gameMenufilename);
...
SFML_ingameMenu::~SFML_ingameMenu()
{
	m_menuText.clear();
}

void SFML_ingameMenu::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
...
int SFML_ingameMenu::update(sf::Time elapsedTime)
{
